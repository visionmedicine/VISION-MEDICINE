...
mixer.pre_init(frequency=48000, buffer=2048)  # 48 kHz, buffer biar stabil
mixer.init()
...
def tts_to_wav(text, filename):
    ...
    sound = sound.set_frame_rate(48000)  # pastikan 48kHz supaya cocok dengan mixer
...
# === Audio playback thread via pygame.mixer ===
