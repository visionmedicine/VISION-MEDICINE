...
const char* ssid = "Kos 57 Alkautsar";                                                       // ## INSERT your wlan ssid
const char* password = "57alkautsar";                                                // ## INSERT your password
const char* OPENAI_KEY = "***************************************";  // ## optionally (needed for Open AI voices): INSERT your OpenAI key
const char* gemini_KEY = "AIzaSyBgzzr2_rUez3Y8yhTfRUypkcQNw4LczeM";                   //gemini api
...
#define TTS_GOOGLE_LANGUAGE "id-ID"  // needed for Google TTS voices only (not needed for multilingual OpenAI voices :) \
